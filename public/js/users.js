...
var _usersDisplayUsers = require('./users/displayUsers');
...
(function (window) {
  ...
  (0, _jquery2['default'])('.show-add-fields').on('click', function () {
    (0, _jquery2['default'])('.add-user').slideToggle();
  });
})(window);
...
var UsersTable = (function () {
  function UsersTable(table, modal) {
  ...
  _createClass(UsersTable, [{
    ...
    value: function displayUsers(users) {
      ...
      users.forEach(function (user, index) {
        _this2.table.append(_this2.template(user));
      });
    }
  }, {
    key: 'template',
...
var Modal = (function () {
  ...
  _createClass(Modal, [{
    ...
    value: function getParams(data, method) {
      var id = $(data[0])[method]();
      var name = $(data[1])[method]();
      var email = $(data[2])[method]();
      var role = $(data[3])[method]();
